...
namespace vin.Command.env.shel_scripting_lang.ByteCode
{
    internal class ByteCodeVM
    {
        ...
        public class VirtualMachine
        {
            ...
            public static void StartRunningTheCodes(List<string> code)
            {
                ...
                {
                    VinErrorList.New("UserDefined: Code: Is Empty!");
                    VinErrorList.ListThem();
                }
            }
        ...
        public class Process
        {
            public class ByteCode
            {
                ...
                public static void Please(List<string> codes)
                {
                    ...
                    if (codeLen >= MaxLen)
                    {
                        VinErrorList.New($"VM: Message: Your code is bigger than expected!\n\tYour Code Length: {codeLen}\n\tMax Code Process Length: {MaxLen}");
                        VinErrorList.ListThem();
                    }
                    else
                    {
                        VinWarningList.New("ByteCode Virtual Machine: May cause some errors!");
                        VinWarningList.ListThem();
                        VinWarningList.CacheClean();
